...
function FollowButton() {
  ...
  return (
    <button
      ...
      className="bg-[#C8F331] rounded-[24px] h-[48px] sm:h-[54px] w-full flex items-center justify-center gap-2 font-medium text-[14px] text-[#101112] hover:bg-[#b8e321] transition-colors shrink-0"
    >
      <i
        className={`fa-solid ${isFollowing ? "fa-check" : "fa-user-plus"}`}
      ></i>
